...
DEBUG = False
default_manifest = ".repo/manifests/snippets/pti_default.xml"
custom_local_manifest = ".repo/local_manifests/pti_manifest.xml"
custom_default_revision = "8.1"
custom_dependencies = "pti.dependencies"
org_manifest = "PTI-Devices"  # leave empty if org is provided in manifest
org_display = "PTI-Devices"  # needed for displaying
